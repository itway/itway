    ...
    <div class="header" style='text-align: center'>
        @if($createdByUser === true)
            ...
            <a class="button button-primary"
               href="{{route('itway::teams::edit', $team->id)}}">{{trans('messages.yourteamBTN')}}</a>
            ...
            <small class="text-center text-info">
                delegate ownership by clicking <i class="text-danger icon-lock_open"></i> to
                <small class="text-primary">Team Users</small>
            </small>
        @endif
    </div>
    <div class="ui cards">
        <div class="card fluid">
            <div class="content">
                <div class="single-team exists-slot">
                            ...
                            <div class="card">
                                ...
                                <div class="extra content">
                                    <div class="left floated author text-info">
                                        <button class="button button-default button-small-card"><i
                                                    class="icon-lock_open"></i></button>
                                    </div>
                    ...
                    <div class="time text-center" style="margin-top: 10px">
