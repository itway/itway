                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="post-author l-6  m-6  s-6 xs-6">
                                        <img class="avatar"
                                             src="@include('includes.user-image', $user = $post->user)"
                                             alt="{{ $post->user->name }}"/>
                                ...
                                <td>
                                    <a class="text-left text-primary"
                                       ...
                                       data-disqus-identifier="post#{{$post->id}}"
                                       style="padding-right: 10px;">0 </a>
                                    <i style="text-align: right; margin: -5px;" class="icon-comment"></i>
                                </td>
                                <td>
                                        <span class="text-left text-primary"
                                              style="padding-right: 10px;">{{$post->views_count()}}</span><i
                                ...
                                <td>
                                    <a class="read-post text-default" target="_blank"
