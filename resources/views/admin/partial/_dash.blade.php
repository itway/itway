            ...
            <section class="l-6 connectedSortable">
                ...
                <div class="box box-danger" id="loading-example">
                    <div class="box-header">
                        ...
                        <div class="pull-right box-tools">
                            <button class="button button-danger button-s refresh-button" data-toggle="tooltip" title="Reload"><i class="fa fa-refresh"></i></button>
                            <button class="button button-danger button-s" data-widget='collapse' data-toggle="tooltip" title="Collapse"><i class="fa fa-minus"></i></button>
                            <button class="button button-danger button-s" data-widget='remove' data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>
                        </div><!-- /. tools -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-s-5">
                                <div class="pad">
                                    ...
                                    <!-- Buttons -->
                                    <p>
                                        <button class="button button-default button-s"><i class="fa fa-cloud-download"></i> Generate PDF</button>
                                    </p>
                                </div><!-- /.pad -->
                            </div><!-- /.col -->
                        </div><!-- /.row - inside box -->
                    ...
                    <div class="box-header">
                        ...
                        <div class="pull-right box-tools">
                            ...
                            <div class="button-group">
                                <button class="button button-warning button-s dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bars"></i></button>
                ...
                <div class="box box-info">
                    <div class="box-header">
                        ...
                        <!-- tools box -->
                        <div class="pull-right box-tools">
                            <button class="button button-info button-s" data-widget="remove" data-toggle="tooltip" title="Remove"><i class="fa fa-times"></i></button>
                        </div><!-- /. tools -->
                    </div>
                    <div class="box-body">
            ...
            <section class="l-6 connectedSortable">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <!-- tools box -->
                        <div class="pull-right box-tools">
                            <button class="button button-primary button-s daterange pull-right" data-toggle="tooltip" title="Date range"><i class="fa fa-calendar"></i></button>
                            <button class="button button-primary button-s pull-right" data-widget='collapse' data-toggle="tooltip" title="Collapse" style="margin-right: 5px;"><i class="fa fa-minus"></i></button>
                        </div><!-- /. tools -->
                    ...
                    <div class="box-body no-padding">
                        <div class="table-responsive">
                            ...
                            <table class="table table-striped">
                                <tr>
                                    <th>All Users</th>
                                    <th>Loggedin Visitors</th>
                                    <th>Guest Visitors</th>
                                    <th>Page Views</th>
                                </tr>
                                <tr>
                                    {{--<td>{!! Visitor::all()->count()!!}</td>--}}
                                    <td>{!! Visitor::loggedIn()->count() !!}</td>
                    ...
                    <div class="box-header">
                        ...
                        <div class="box-tools pull-right" data-toggle="tooltip" title="Status">
                            <div class="button-group" data-toggle="button-toggle" >
                                <button type="button" class="button button-default button-s active"><i class="fa fa-square text-green"></i></button>
                                <button type="button" class="button button-default button-s"><i class="fa fa-square text-red"></i></button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="item">
                            ...
                            <div class="attachment">
                                ...
                                <div class="pull-right">
                                    <button class="button button-primary button-s button-flat">Open</button>
                                </div>
                            </div><!-- /.attachment -->
                        </div><!-- /.item -->
                        <!-- chat item -->
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        ...
                        <div class="box-tools pull-right">
                            <ul class="pagination pagination-s inline">
