        ...
        <section class="l-6 connectedSortable">
            ...
            <div class="ui card box-danger" id="loading-example">
                <div class="box-header">
                    ...
                    <div class="pull-right box-tools">
                        <button class="button button-danger button-s refresh-button" data-toggle="tooltip"
                                title="Reload"><i class="fa fa-refresh"></i></button>
                        <button class="button button-danger button-s" data-widget='collapse' data-toggle="tooltip"
                                title="Collapse"><i class="fa fa-minus"></i></button>
                        <button class="button button-danger button-s" data-widget='remove' data-toggle="tooltip"
                    ...
                    <div class="row">
                        ...
                        <div class="col-s-5">
                            <div class="pad">
                                ...
                                <!-- Buttons -->
                                <p>
                                    <button class="button button-default button-s"><i class="fa fa-cloud-download"></i>
                                        Generate PDF
                                    </button>
                                </p>
                            </div><!-- /.pad -->
                ...
                <div class="box-header">
                    ...
                    <div class="pull-right box-tools">
                        ...
                        <div class="button-group">
                            <button class="button button-warning button-s dropdown-toggle" data-toggle="dropdown"><i
            ...
            <div class="box box-info">
                <div class="box-header">
                    ...
                    <!-- tools box -->
                    <div class="pull-right box-tools">
                        <button class="button button-info button-s" data-widget="remove" data-toggle="tooltip"
                                title="Remove"><i class="fa fa-times"></i></button>
                    </div><!-- /. tools -->
                </div>
                <div class="box-body">
                ...
                <div class="box-footer clearfix">
                    <button class="pull-right button button-default" id="sendEmail">Send <i
        ...
        <section class="l-6 connectedSortable">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <!-- tools box -->
                    <div class="pull-right box-tools">
                        <button class="button button-primary button-s daterange pull-right" data-toggle="tooltip"
                                title="Date range"><i class="fa fa-calendar"></i></button>
                        <button class="button button-primary button-s pull-right" data-widget='collapse'
                ...
                <div class="box-header">
                    ...
                    <div class="box-tools pull-right" data-toggle="tooltip" title="Status">
                        <div class="button-group" data-toggle="button-toggle">
                            <button type="button" class="button button-default button-s active"><i
                                        class="fa fa-square text-green"></i></button>
                            <button type="button" class="button button-default button-s"><i
