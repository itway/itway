...
@section('content')
    ...
    @if($threads->count() > 0)
        ...
        @foreach($threads as $thread)
            ...
            <a href="{{route("itway::chat.show", $thread->id)}}" class="media alert {!!$class!!}" data-roomId="{{ $thread->id }}">
    ...
    <div class="chat l-12 m-12 s-12 xs-12">
        <div class="text-center">
            ...
            <a id="create-room" class="button button-l button-link text-info text-center" style="text-decoration: underline">#Create a new room</a>
            <div id="no-room">
