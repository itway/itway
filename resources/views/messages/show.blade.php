                    ...
                    <div class="ui minimal comments">
                        ...
                        @foreach($thread->messages as $message)
                            ...
                            <div class="comment" data-comment-user="{!!$message->user->id!!}">
                                <a class="avatar">
                                    <img src="@include('includes.user-image', $user = $message->user)"
                                ...
                                <div class="content">
                                    ...
                                    <div class="metadata">
                                        <span class="date"><i
                                                    class="icon-clock-o"></i> Posted {!! $message->created_at->diffForHumans() !!}</span>
                                    </div>
                                    <div class="text">
                                        {!! $message->body !!}
                                    </div>
                                    <div class="actions">
                                        <a class="reply" data-message="{!! $message->id !!}"><i class="icon-plus"></i>
                                            Reply</a>
                                    </div>
                                </div>
                            </div>
