    ...
    <div class="bg-white" style="">
        ...
        <div class="l-12 m-12 s-12 create-form">
            ...
            <div class="field">
                <div class="tag-block">
                    ...
                    <select multiple style="z-index: 25!important;" name="tags_list[]"
                        ...
                        <option value="">Event tags</option>
            ...
            <div class="three fields">
                <div class="field">
                    <input type="time" value="{{\Carbon\Carbon::createFromTime(12, 0, 0, 'Europe/London')->toTimeString()}}" placeholder="time of event" class="input-line time">
                </div>
                <div class="field">
            ...
            <div class="" style="text-align: center">
                ...
                {!! Form::submit('Create event', ['class' => 'confirm button button-primary'])!!}
            </div>
        </div>
        {!! Form::close() !!}
        <div class="clearfix"></div>
