                            ...
                            <div class="photo-block">
                                <div class="thumbnail" style='background: #ffffff'>
                                    @foreach($picture as $pic)
                                        <img  class="img-responsive" style="" src="{!! asset('images/teams/' . $pic->path) !!}">
                                    @endforeach
                                </div>
                            </div>
                @else
    ...
    <div class="field">
        ...
        <div class="field">
            <div class="tag-block">
                ...
                <div class="clearfix"></div>
                <select multiple  style="z-index: 25!important;" name="tags_list[]" class="ui skills fluid multiple search normal selection dropdown">
                    ...
                    <option value="info. architecture">Information Architecture</option>
