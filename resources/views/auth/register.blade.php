        ...
        <div class="l-8 l-offset-2 m-8 m-offset-2 s-10 s-offset-1 xs-12  bg-white">
            ...
            <form class="form" role="form" method="POST" action="{{ url('/auth/register') }}">
                ...
                <div class="form-group">
                    ...
                    <div class="l-6 m-6 s-7 xs-7">
                        <input type="text" class="input input-line" placeholder=" type your name" name="name"
                               value="{{ old('name') }}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="l-6 m-6 s-7 xs-7">
                        <input type="email" class="input input-line" placeholder=" type your e-mail" name="email"
                               value="{{ old('email') }}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="l-6 m-6 s-7 xs-7">
                        <input type="password" class="input input-line" placeholder=" type your password"
                               name="password">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="l-6 m-6 s-7 xs-7">
                        <input type="password" class="input input-line" placeholder=" type your confirm password"
            ...
            <div class="form-group text-center">
                <div class=" l-12 s-12 xs-12">
                    <a id="facebook" href="{{url('/auth/login/facebook')}}" class="button button-primary">Facebook <span
                                class="icon-facebook"></span>
                    </a>
                    <a id="google" href="{{url('/auth/login/google')}}" class="button button-danger">Google+ <span
                                class="icon-google"></span>
                    </a>
                    <a id="github" href="{{url('/auth/login/github')}}" class="button button-default">github <span
