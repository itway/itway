            ...
            <div class="ui inline dropdown item">
                ...
                <div class="menu">
                        ...
                        @if(Request::route()->getPrefix() === App::getLocale()."/teams")
                            <a class="item block active selected" href="{{route("itway::teams::index")}}"><i class="icon-group text-right"></i> {{ trans('navigation.Teams') }}</a>
                        @else
                            <a class="item block" href="{{route("itway::teams::index")}}"><i class="icon-group text-right"></i> {{ trans('navigation.Teams') }}</a>
                        @endif
                        @if(Request::route()->getPrefix() === App::getLocale()."/chat")
                                <a class="item block active selected" href="{{route("itway::chat")}}"><i class="icon-chat"></i> {{ trans('navigation.Chat') }}</a>
                        @else
                                <a class="item block" href="{{route("itway::chat")}}"><i class="icon-chat"></i> {{ trans('navigation.Chat') }}</a>
                        @endif
                        @if(Request::route()->getPrefix() === App::getLocale()."/events")
                                <a class="item block active selected" href="{{route("itway::events::index")}}"><i class="icon-group text-right"></i> {{ trans('navigation.Event') }}</a>
                        @else
                                <a class="item block" href="{{route("itway::events::index")}}"><i class="icon-event text-right"></i> {{ trans('navigation.Event') }}</a>
                        @endif
                        @if(Request::route()->getPrefix() === App::getLocale()."/idea-show")
                                <a class="item block active selected" href="{{route("itway::idea-show::index")}}"><i class="icon-graduation-cap"></i> {{ trans('navigation.Idea-Share') }}</a>
                        @else
                                <a class="item block" href="{{route("itway::idea-show::index")}}"><i class="icon-graduation-cap"></i> {{ trans('navigation.Idea-Share') }}</a>
                        @endif
                        @if(Request::route()->getPrefix() === App::getLocale()."/blog")
                        <a class="item block active selected" href="{{route("itway::posts::index")}}" ><i class="icon-pencil"></i> {{ trans('navigation.Blog') }}</a>
                        @else
                        <a class="item block" href="{{route("itway::posts::index")}}" ><i class="icon-pencil"></i> {{ trans('navigation.Blog') }}</a>
                        @endif

                        @if(Request::route()->getPrefix() === App::getLocale()."/job-hunting")
                        <a class="item block active selected" href="{{route("itway::job::index")}}"><i class="icon-briefcase text-right"></i> {{ trans('navigation.Job-Hunt') }}</a>
                        @else
                        <a class="item block" href="{{route("itway::job::index")}}"><i class="icon-briefcase text-right"></i> {{ trans('navigation.Job-Hunt') }}</a>
                        @endif
                </div>
            </div>
        </div>
