<div class="l-12 m-12 s-12 create-form">
    <div class="field">
        <div class="title-block ">
            <span class="label titl">{{trans('openidea-form.name')}}</span>
            <div class="clearfix"></div>
            {!! Form::text('name', null, ['class' => 'input-line', 'id' => 'title','placeholder' => 'insert openidea\'s name here      (max:120)'])!!}
            <div class="pos-rel">
    ...
    <div class="field">
            <div class="tag-block">
                <span class="label titl">#{{trans('openidea-form.tags')}}</span>
                <div class="clearfix"></div>
                <select multiple  style="z-index: 25!important;" name="tag_list" class="ui skills fluid multiple search normal selection dropdown">
    ...
    <div class="two fields">
        <div class="field">
            <select multiple="multiple" style="z-index: 24!important;" name="trend" class="ui selection dropdown" id="select-trend">
...
@include('openideas.create-openidea-scripts')
