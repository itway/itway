...
class Teamwork
{
    ...
    public function inviteToTeam( $user, $team = null, callable $success = null )
    {
        ...
        $invite               = $this->app->make('Itway\Components\teamwork\Teamwork\TeamInvite');
    ...
    public function hasPendingInvite( $email, $team )
    {
        ...
        return $this->app->make('Itway\Components\teamwork\Teamwork\TeamInvite')->where('email', "=", $email)->where('team_id', "=", $team )->first() ? true : false;
    }
    ...
    {
        return $this->app->make('Itway\Components\teamwork\Teamwork\TeamInvite')->where('accept_token', '=', $token)->first();
    }
    ...
    {
        return $this->app->make('Itway\Components\teamwork\Teamwork\TeamInvite')->where('deny_token', '=', $token)->first();
    }
