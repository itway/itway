<?php namespace Itway\Components\Messenger\Domain;

use Itway\Components\Messenger\Domain\Thread\Thread;
use Itway\Components\Messenger\Domain\Thread\ThreadService;
