<?php namespace Itway\Components\Messenger\Traits;
...
trait Messagable
{
    ...
    {
        return $this->hasMany('Itway\Components\Messenger\Models\Message');
    }
    ...
    {
        return $this->belongsToMany('Itway\Components\Messenger\Models\Thread', 'participants');
    }
